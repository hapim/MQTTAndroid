...
public class ModelConnectionPersistence {
	...
	/**
	 * The serverURI that the {@link MqttAndroidClient} represented by this
	 * <code>Connection</code> is represented by
	 **/
	...
	private int port = 0;
	/**
	 * {@link ConnectionStatus} of the {@link MqttAndroidClient} represented by
	 * this <code>Connection</code> object. Default value is
	...
	/** Persistence id, used by {@link DatabaseConnectionPersistence} **/
	 ...
	 * attempting to create a {@link MqttAndroidClient} and the client handle.
	 * 
	 * @param clientId
	 *            The id of the client
	 * @param host
	 *            the server which the client is connecting to
	 * @param port
	 *            the port on the server which the client will attempt to
	 *            connect to
	 * @param context
	 *            the application context
	 * @param sslConnection
	 *            true if the connection is secured by SSL
	 * @return a new instance of <code>Connection</code>
	 */
	public static ModelConnectionPersistence createConnection(String clientId,
			String host, int port, Context context, boolean sslConnection,
		...
		ModelConnectionPersistence con = new ModelConnectionPersistence(handle,
				clientId, host, port, context, client, sslConnection);
		con.setServerURI(uri);
		return con;
	}
	 ...
	 * 
	 * @param clientHandle
	 *            The handle to this <code>Connection</code> object
	 * @param clientId
	 *            The Id of the client
	 * @param host
	 *            The server which the client is connecting to
	 ...
	 *            The application context
	 * @param client
	 *            The MqttAndroidClient which communicates with the service for
	 *            this connection
	 * @param sslConnection
	 *            true if the connection is secured by SSL
	 */
	public ModelConnectionPersistence(String clientHandle, String clientId,
			String host, int port, Context context, MqttAndroidClient client,
	...
	/**
	 * Gets the server URI for this connection
	 * 
	 * @return server URI for this connection
	 */
	...
	/**
	 * set the server URI for this connection
	 */
	...
	public boolean equals(Object o) {
		if (!(o instanceof ModelConnectionPersistence)) {
			return false;
		}

		ModelConnectionPersistence c = (ModelConnectionPersistence) o;
